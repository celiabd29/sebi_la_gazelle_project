...
const ScorePage = () => {
 ...
 useEffect(() => {
  ...
  const handleNext = () => {
    navigate(`/jeuxDrys/GamePage?level=${level + 1}`);
  };
      ...
      <div className="flex justify-center gap-3 mb-4">
        {[...Array(3)].map((_, index) => (
          <img
            ...
            } ${index === 1 ? "xl:-mt-10 -mt-4" : "mt-0"}`} // étoile du milieu plus haute
          />
        ))}
      </div>
  ...
  {/* ➡️ Niveau suivant - visible seulement si réussite */}
  {isSuccess && (
    <button
      onClick={handleNext}
    ...
    {/* CLASSEMENT : À gauche sur desktop, en bas sur mobile */}
