...
import palierSoundEn from "../../assets/sounds/drys_sounds/anglais/palier1.m4a";
import palierLoopSoundEn from "../../assets/sounds/drys_sounds/anglais/Choose_your_level.m4a";
...
const PalierPage = () => {
  ...
  if (!soundOn) return;
    ...
    const start =
      i18n.language === "fr" ? new Audio(palierSound) : new Audio(palierSoundEn);
    const loop =
      i18n.language === "fr"
        ? new Audio(palierLoopSound)
        : new Audio(palierLoopSoundEn);
    ...
    start.play().catch(() => console.log("❌ son palier bloqué"));

    start.onended = () => {
      loop.play().catch(() => console.log("❌ son loop bloqué"));
